...
export class SandpileRugged {
  ...
  constructor(maxParticles, width, height) {
    ...
    // Flattened table storing lattice point occupancy. pile(x,y) represents
    // a list of the indices of particles piled up at lattice point (x,y).
    // n = pile(x,y)[0] is the number of particles and pile(x,y)[i] is the
    // index of i-th stacked particle (1 <= i <= n). This optimization
